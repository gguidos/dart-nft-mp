...
import makeInsertOne from '../app/component/user/libs/data-access/insert-one';
import makeFindDocuments from '../app/component/user/libs/data-access/find-documents';
import makeDeleteDocument from '../app/component/user/libs/data-access/delete-document';
import makeDeleteDocuments from '../app/component/user/libs/data-access/delete-documents';
